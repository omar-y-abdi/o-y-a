...
const js = {};
for (const name of ['privacy','cards','playlogic','games','joy','contact','main']) {
...
await writeFile('.generated/build.json',JSON.stringify({routes:indexed.map(page => page.path),js,styles},null,2));
