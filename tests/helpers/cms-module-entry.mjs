...
globalThis.cmsTest = { remapClone, editableText, replaceEditableText, createEditor, componentInspector, loadCards, loadCopy, renderWin, exportWin, disposeWin, previewData, nudgeComponent, captureEditorView, restoreEditorView, centerOffset, synchronizeSharedPageClient };
