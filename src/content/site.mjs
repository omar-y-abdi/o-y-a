...
export const routes = Object.freeze([
  ...
  { path:'/projekt/blade-blend/', name:'Blade & Blend', title:'Blade & Blend Studio | Fullstack av Omar Yusuf', description:'En soloutvecklad fullstack-webbplats för en barbershop i Göteborg. Läs om bokning, gränssnitt och backend.', template:'blade' },
  { path:'/projekt/backhaul/', name:'Backhaul', title:'Backhaul | SSEN National Hackathon 2026 | Omar Yusuf', description:'Omar Yusufs deltagande i Einride Track på SSEN National Hackathon 2026. Ett lagbidrag om möjliga returlaster.', template:'backhaul' },
  { path: '/kontakt/', name: 'Säg hej', title: 'Säg hej | Kontakt med Omar Yusuf', description: 'En idé, ett projekt eller en fråga om Furl? Kontakta Omar Yusuf eller hitta hans offentliga projekt. Skicka ett meddelande genom kontaktsidans kuvert.', template: 'contact' },
