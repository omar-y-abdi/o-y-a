...
<body class="page-${page.template}" data-page="${page.path}">
...
<footer class="site-footer"><div class="footer-main"><a class="brand footer-brand" href="/">${flower('brand-mark')}<span>omar yusuf.</span></a><p>Lite hjärna. Lite hjärta.<br>Ganska mycket nyfikenhet.</p><a class="footer-back" href="#main">Upp igen ${icon('down')}</a></div>
